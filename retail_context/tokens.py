...
def methodology() -> str:
    """Name the currently active counting path (recorded verbatim in budget.json)."""
...
def count(text: str) -> int:
    ...
    # Heuristic fallback. The cap of 1 is intentional — a non-empty string
    # never reports 0 tokens.
